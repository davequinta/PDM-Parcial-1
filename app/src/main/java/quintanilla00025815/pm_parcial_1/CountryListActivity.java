...
public class CountryListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCountries = intent.getParcelableArrayListExtra("countries");
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(mCountries));
    }

    public class SimpleItemRecyclerViewAdapter
            extends RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder> {

        private final ArrayList<Country> mValues;

        public SimpleItemRecyclerViewAdapter(ArrayList<Country> items) {
            mValues = items;
        }
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.mFlagView.setImageResource(holder.mItem.getFlag());
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putParcelable(CountryDetailFragment.ARG_ITEM, holder.mItem);
                        ...
                        intent.putExtra(CountryDetailFragment.ARG_ITEM, mCountries.get(position));
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                super(view);
                mView = view;
                mFlagView = (ImageView) view.findViewById(R.id.country_img);
